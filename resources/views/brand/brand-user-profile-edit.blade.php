...
<body>
    ...
    <main class="mt-3 text-start tblack main" data-bs-spy="noscroll">
        <form method="POST" action="{{ route('brand.user.profile.update') }}">
            @csrf
            <div class="container-fluid">
        ...
        <form id="cancel-profile-edit" method="GET" action="{{ route('brand.user.profile.create') }}">
            @csrf
        </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="change-password-form" method="POST" action="{{ route('brand.user.profile.password.update') }}">
                            @csrf
                            <div class="mb-3">
