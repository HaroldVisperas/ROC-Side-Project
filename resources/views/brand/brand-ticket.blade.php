        ...
        <div class="container-fluid">
            <div class="row justify-content-center contents">
                <div class="container table-container">
                    <form method="GET" action="{{ route('brand.tickets.create_ticket') }}">
                        <div class="table-header d-flex justify-content-end">
                            <button class="btn">Create a new ticket</button>
                        </div>
                    </form>
                        ...
                        <tbody>
                            @foreach($tickets as $ticket)
                                <tr>
                                    <td>{{ $ticket->title }}</td>
                                    <td>{{ $ticket->status }}</td>
                                    <td>{{ $ticket->created_at->setTimezone(auth()->user()->timezone)->format('m-d-Y') }}</td>
                                    <td>{{ $ticket->updated_at->setTimezone(auth()->user()->timezone)->format('m-d-Y') }}</td>
                                    <td>
                                        <form method="GET" action="{{ route('brand.tickets.view') }}">
                                            <input type="hidden" name="ticket_id" value="{{ $ticket->id }}">
                                            <button type="submit" class="btn green twhite">View</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
