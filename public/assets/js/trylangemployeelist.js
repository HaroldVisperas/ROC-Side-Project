function editButton(editButtonId, deleteButtonId, saveButtonId, cancelButtonId, 
    displayEmployeeId, editEmployeeId, displayPosition, editPosition, displayAffiliation, editAffiliation) {
    ...
    document.getElementById(displayAffiliation).style.display = 'none';
    document.getElementById(editAffiliation).style.display = 'inline-block';
}
...
function saveButton(editButtonId, deleteButtonId, saveButtonId, cancelButtonId) {
    ...
    document.getElementById('displayAffiliation').style.display = 'inline-block';
    document.getElementById('editAffiliation').style.display = 'none';
}