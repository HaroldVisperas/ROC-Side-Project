...
class ProfileController extends Controller
{
    public function create_individual()
    {
        ...
        return view('individual.individual-profile', compact('timezones'));
    }
    ...
    public function create_company(Request $request)
    {
        ...
        return view('company.company-profile', compact('timezones'));
    }

    public function update_company_timezone(Request $request)
    {
        $user = auth()->user();
        $user->timezone = $request->timezone;
        $user->save();

        return redirect()->route('company.profile.create')->with('success', 'Timezone updated successfully.');
    }
