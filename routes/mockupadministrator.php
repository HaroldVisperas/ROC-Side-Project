...
Route::middleware('auth', 'verified')->group(function () {
    ...
    Route::post('/mockup/administrator/announcement/store', [MockupAdministratorController::class, 'store_announcement'])->name('mockup.administrator.store.announcement');
